...
class IntegrationTest(unittest.TestCase):
    ...
    def test_rang_und_disziplin_russikon(self):
        ...
        actual = ask_question("Auf welchem Rang war Russikon? Und in welcher Disziplin?")
        a = assert_meaning("Russikon war auf dem 6. Rang in der Disziplin XY", actual)
        self.assertTrue(a)

    def test_rang_russikon_team_aerobic_und_maximalpunktzahl(self):
        # TODO: expected herausfinden
        actual = ask_question("Auf welchem Rang war Russikon in der Disziplin Team Aerobic und was ist die maximale Punktzahl?")
        a = assert_meaning("Russikon war auf dem ersten Rang in der Disziplin Team Aerobic. Die maximale Punktzahl beträgt X.", actual)
        self.assertTrue(a)
    ...
    def test_abzug_verstoss(self):
        actual = ask_question("Wieviel Abzug gibt Verstoss gegen die Teilnahmeberechtigung?")
        a = assert_meaning("Ein Verstoss gegen die Teilnahmeberechtigung führt zu einem Abzug von 1.0 Punkt.", actual)
        self.assertTrue(a)
    
    def test_zeit_TSV_Rohrdorf_Kategorie_RE(self):
        # TODO: expected herausfinden
        actual = ask_question("Wann turnt der TSV Rohrdorf in der Kategorie RE?")
        a = assert_meaning("Der Verein TSV Rohrdorf turnt um XY in der Kategorie RE", actual)
        self.assertTrue(a)
